    ...
    protected function getTableColumns(): array
    {
        return [
            ...
            TextColumn::make('due_date')
                ...
                ->sortable()
                ->color(fn ($record) => 
                    Carbon::parse($record->due_date)->diffInDays(now()) <= 3 
                        ? 'warning' 
                        : 'gray'
                )
                ->description(fn ($record) => 
                    'Due in ' . Carbon::parse($record->due_date)->diffForHumans(null, true)
                ),
            ...
            BadgeColumn::make('payment_progress')
                ->label('Paid')
